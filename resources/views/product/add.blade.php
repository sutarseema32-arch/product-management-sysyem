...
<div class="container mt-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form  method="POST" enctype="multipart/form-data" id="productForm"   data-url="{{ route('product.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_price" name="product_price" class="form-control" placeholder="Enter Product Price">
                ...
                <div class="form-group">
                    ...
                    <textarea id="product_desc" name="product_desc" rows="5" class="form-control" placeholder="Enter Product Description"></textarea>
